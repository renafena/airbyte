...
import io.airbyte.integrations.destination.snowflake.typing_deduping.SnowflakeSqlGenerator.Companion.escapeJsonIdentifier
...
object SnowflakeTestUtils {
    ...
    private fun quote(name: String): String {
        return '"'.toString() + escapeJsonIdentifier(name) + '"'
    }
